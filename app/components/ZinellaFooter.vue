...
const sections = [
  {
    ...
    links: [
      { label: "La società storica di Bologna. Passione, dedizione e sportività dal 1970. Alleniamo i campioni di domani.", to: "/" },
    ],
    social: [
      { icon: "i-simple-icons-facebook", link: "https://facebook.com" },
